...
<div class="row bio">
 <div class="panel home">
   <h2>Emily Shewmaker</h2>
   <h4>Residential Programs Manager</h4>
   <p>Emily Shewmaker joined FroSoCo in January of 2015 but has been part of the Stanford family since September of 2013. She serves as the Residential Programs Coordinator/Program Administrator for FroSoCo, Potter, and Robinson. She helps support the academic programming throughout the year while growing and expanding program ideas. Prior to moving to the Bay Area, Emily worked for the Institute for Forensic Science at Texas Tech University where she helped build and establish an academic program from the ground up. She is a Texas native, lover of excellent food, traveling, and is always up for a good conversation.</p>
</div>
<div class="panel pic">
    <img src="/assets/images/seniorstaff/emily.jpg"  />
    <div class="caption">
        <p>Emily Shewmaker</p>
    </div>
</div>
